...
GlobePolylineDrawer.prototype = {
    ...
    startDrawPolyline: function (okHandler, cancelHandler) {
        ...
        let lastClickTime = 0;
        // 双击间隔
        const DOUBLE_CLICK_THRESHOLD = 300; // Adjust the threshold as needed (in milliseconds)
    ...
    _showPolyline2Map: function () {
        ...
        if (_this.material == null) {
            _this.material = new Cesium.PolylineOutlineMaterialProperty({
                color: Cesium.Color.fromCssColorString('#f00').withAlpha(1),
                outlineColor: Cesium.Color.fromCssColorString('#f00').withAlpha(1),
                outlineWidth: 1
            });
        }
...
export default GlobePolylineDrawer