...
import {
    CallbackProperty, Cartesian3, Color, PolygonGraphics, PolygonHierarchy, PolylineDashMaterialProperty, PolylineOutlineMaterialProperty,ScreenSpaceEventHandler, ScreenSpaceEventType, defined,
} from 'cesium'
