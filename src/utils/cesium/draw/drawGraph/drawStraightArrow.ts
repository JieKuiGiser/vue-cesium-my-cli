...
import {
    CallbackProperty, Color, PolygonGraphics, PolygonHierarchy, PolylineDashMaterialProperty, PolylineOutlineMaterialProperty,ScreenSpaceEventHandler, ScreenSpaceEventType,
} from 'cesium'
